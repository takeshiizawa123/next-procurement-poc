...
const SAMPLE_PENDING: MockRequest[] = [
  { prNumber: "PR-0055", applicationDate: "2026-03-28", itemName: "ノートPC Dell Latitude 5550", totalAmount: 248000, supplierName: "Amazon.co.jp", applicant: "田中太郎", department: "営業部", debitAccount: "工具器具備品", debitConfidence: "high", creditAccount: "未払金", creditSubAccount: "MFカード:未請求", taxCategory: "共-課仕 10%", paymentMethod: "MFカード", slackLink: "#", hubspotDealId: "", memo: "2026/03 PR-0055 Amazon.co.jp", ocrTaxRate: 10, ocrAmount: 248000, ocrAmountMatch: true, ocrRegistrationNumber: "T1234567890123", ocrRegistrationName: "アマゾンジャパン合同会社", voucherType: "領収書", voucherFileName: "PR-0055_Amazon_領収書.pdf", voucherDriveUrl: "#" },
  ...
  { prNumber: "PR-0051", applicationDate: "2026-03-26", itemName: "A4コピー用紙 5000枚 x 10箱", totalAmount: 32000, supplierName: "ASKUL", applicant: "鈴木一郎", department: "管理本部", debitAccount: "消耗品費", debitConfidence: "high", creditAccount: "未払金", creditSubAccount: "MFカード:未請求", taxCategory: "共-課仕 10%", paymentMethod: "MFカード", slackLink: "#", hubspotDealId: "", memo: "2026/03 PR-0051 ASKUL", ocrTaxRate: 10, ocrAmount: 31500, ocrAmountMatch: false, ocrRegistrationNumber: "T9876543210987", ocrRegistrationName: "アスクル株式会社", voucherType: "納品書", voucherFileName: "PR-0051_ASKUL_納品書.pdf", voucherDriveUrl: "#" },
  { prNumber: "PR-0049", applicationDate: "2026-03-25", itemName: "会議用プロジェクター EPSON EB-992F", totalAmount: 145000, supplierName: "ヨドバシカメラ", applicant: "山田部長", department: "営業部", debitAccount: "工具器具備品", debitConfidence: "high", creditAccount: "未払金", creditSubAccount: "MFカード:未請求", taxCategory: "共-課仕 10%", paymentMethod: "MFカード", slackLink: "#", hubspotDealId: "", memo: "2026/03 PR-0049 ヨドバシカメラ", ocrTaxRate: 10, ocrAmount: 145000, ocrAmountMatch: true, voucherType: "領収書", voucherFileName: "PR-0049_ヨドバシ_領収書.pdf", voucherDriveUrl: "#" },
...
function JournalDetail({ r, edits, onEdit }: {
  ...
  const creditOptions = CREDIT_MAP[isCard ? "MFカード" : "請求書払い"] || CREDIT_MAP["請求書払い"];
