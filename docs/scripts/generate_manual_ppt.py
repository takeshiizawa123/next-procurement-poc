...
tbl("よくある質問", ["質問", "回答"],
    [
        ...
        ["未申請利用の連絡が来た", "管理本部の照合で検知。/purchase で事後申請を"],
    ], accent=GREEN)

tbl("操作早見表", ["やりたいこと", "操作", "対象"],
    [
        ["購買申請", "/purchase → モーダル or Webフォーム", "全員"],
        ["出張申請", "/trip → モーダル", "全員"],
        ["自分の状況確認", "/purchase/my（マイページ）", "全員"],
        ["承認する", "DM or #purchase-request の [承認]", "部門長"],
        ["発注完了", "[発注完了] ボタン", "申請者/管理"],
        ["検収完了", "[検収完了] ボタン", "申請者"],
        ["証憑提出", "スレッドにD&D or マイページ [証憑UP]", "申請者"],
        ["カード明細照合", "/admin/card-matching → CSV読込", "管理本部"],
        ["引落照合", "/admin/card-matching → 引落照合タブ", "管理本部"],
    ], accent=CYAN)
