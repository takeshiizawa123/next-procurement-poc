...
**版数**: v1.2
**対象**: 全従業員
**最終更新**: 2026-04-12（Googleログイン・検収モーダル追加）
...
3. 送信すると #出張チャンネル に投稿されます（日当が自動計算されて表示）
4. DMで確認通知が届きます（概算額 + 日当 = 合計見込が表示）
...
日当は申請時に自動計算され、Slack投稿とDMに合計見込として表示されます。支給は給与と合わせて行われます。
