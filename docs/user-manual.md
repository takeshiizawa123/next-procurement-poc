...
**版数**: v1.4
**対象**: 全従業員
**最終更新**: 2026-04-13（全文検索・Slack AIアシスタントを反映）
...
- **検索バー**: 品目名・仕入先名・備考をキーワードで全文検索できます（部分一致対応）
...
| 過去の申請を検索する | `/purchase/my` 検索バーにキーワード入力 | 全員 |
| AIに質問する | Slackで `/ask 質問内容` | 全員 |
...
| 日付 | 版数 | 変更内容 |
|------|------|---------|
| 2026-04-13 | v1.4 | マイページに全文検索バー追記、Slack AIアシスタント（/ask）操作早見表追加 |
